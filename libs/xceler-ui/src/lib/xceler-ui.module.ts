...
import {
  faAdd, faBackward, faBackwardFast,
  faCopy, faExpandAlt, faFileExport,faFilter,
  faFileImport, faForward, faForwardFast, faMinimize, faPencilAlt,
  faRedo, faSave, faThumbtack, faTimes,
  faTrash, faCheck, faCross, faArrowRight, faArrowCircleRight, faArrowCircleLeft, faCalendar, faCircle, faCheckCircle
...
export class XcelerUiModule {
  constructor(library:FaIconLibrary) {
    library.addIcons(faPencilAlt,faCopy,faTrash,faRedo,faAdd,faFileImport,faFileExport,faSave
      ,faTimes,faCheck,faCross,faArrowRight,faArrowCircleRight,faArrowCircleLeft,faCalendar
      ,faCircle,faCheckCircle,faFilter
      ,faExpandAlt,faThumbtack,faMinimize,faForward,faForwardFast,faBackward,faBackwardFast);
  }
}
